...
public class NativeHints {
    ...
    static class Registrar implements RuntimeHintsRegistrar {
        ...
        public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
            ...
            registerPackage(reflection, classLoader, "bo.com.sintesis.mdqr.gateway.service.dto");
            registerPackage(reflection, classLoader, "bo.com.sintesis.mdqr.gateway.web.rest.request");
        }
