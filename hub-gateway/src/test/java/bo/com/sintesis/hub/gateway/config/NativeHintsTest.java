...
class NativeHintsTest {
    ...
    void allHintsRegistered() {
        ...
        // Jackson DTOs
        assertThat(reflection.onType(bo.com.sintesis.hub.gateway.service.dto.TokenResponse.class))
            .accepts(hints);
        assertThat(reflection.onType(bo.com.sintesis.hub.gateway.web.rest.request.LoginRequest.class))
            .accepts(hints);
    }
}
