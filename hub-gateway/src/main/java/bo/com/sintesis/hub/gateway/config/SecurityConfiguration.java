...
import bo.com.sintesis.hub.gateway.web.rest.errors.ApiResponseAccessDeniedHandler;
import bo.com.sintesis.hub.gateway.web.rest.errors.ApiResponseAuthEntryPoint;
...
public class SecurityConfiguration {
    ...
    private final ApiResponseAuthEntryPoint authEntryPoint;
    ...
    // Valida tokens del realm hub-partner.
    @Bean
    @Order(1)
    public SecurityWebFilterChain partnerSecurityChain(
        ...
        http
            ...
            .authorizeExchange(auth -> auth
                ...
                // Todas las rutas /partner/** requieren un JWT válido de hub-partner
    ...
    // Valida tokens del realm hub-admin.
    @Bean
    @Order(2)
