...
import { MDQR_AUTH_CONFIG, MdqrAuthConfig } from './auth-config';

export function provideMdqrAuth(config: MdqrAuthConfig): EnvironmentProviders {
  ...
  return makeEnvironmentProviders([
    { provide: MDQR_AUTH_CONFIG, useValue: config },
    provideKeycloak({
      config: {
      ...
      initOptions: {
        ...
        // /mdqradmin/ el iframe debe cargar /mdqradmin/assets/..., no /assets/...
