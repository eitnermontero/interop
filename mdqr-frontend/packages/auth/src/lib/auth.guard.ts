...
import { MDQR_AUTH_CONFIG } from './auth-config';
...
const isAccessAllowed = async (
  ...
  const config = inject(MDQR_AUTH_CONFIG);
...
export const mdqrAuthGuard: CanActivateFn = createAuthGuard<CanActivateFn>(isAccessAllowed as never);
