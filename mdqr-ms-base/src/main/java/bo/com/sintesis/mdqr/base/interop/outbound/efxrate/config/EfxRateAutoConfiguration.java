package bo.com.sintesis.mdqr.base.interop.outbound.efxrate.config;
...
import bo.com.sintesis.mdqr.base.interop.outbound.efxrate.EfxRateAdapter;
import bo.com.sintesis.mdqr.base.interop.outbound.efxrate.EfxRateClient;
import bo.com.sintesis.mdqr.base.interop.outbound.efxrate.EfxRateProperties;
...
public class EfxRateAutoConfiguration {
    ...
    public EfxRateClient efxRateClient(EfxRateProperties properties,
        ...
        // En local, el fallback es el apiKey del tuxedo (token de desarrollo genérico).
        // TODO(hub-poc): cuando haya un secreto dedicado para local, cambiar este fallback.
        String fallbackApiKey = applicationProperties.getTuxedo().getApiKey();
