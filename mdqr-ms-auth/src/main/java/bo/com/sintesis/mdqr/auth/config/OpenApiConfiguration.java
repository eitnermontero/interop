...
public class OpenApiConfiguration {
    ...
    private Info apiInfo() {
        return new Info()
            .title("MDQR - Admin Service API")
            .version("1.0.0")
            .description("""
                API de administración del sistema MDQR (Middleware de Decodificación QR).
                ...
                Todas las APIs requieren token JWT Bearer del realm `mdqr-admin` de Keycloak.
    ...
    private List<Server> apiServers() {
        return List.of(
            ...
            new Server()
                .url("http://localhost:8080/services/mdqradminservice")
    ...
    private Components apiComponents() {
        return new Components()
            .addSecuritySchemes("bearer-jwt", new SecurityScheme()
                ...
                .description("Token JWT del realm mdqr-admin de Keycloak."));
    }
}
