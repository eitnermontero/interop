...
const THEMES = [
  { id: "sintesis", label: "Síntesis", color: "#0089f7" },
...
const DEFAULT_PALETTE: ThemeId = "sintesis";

function applyPalette(id: ThemeId, baseUrl: string): void {
  ...
  link.href = `${baseUrl}themes/${id}.css`;
