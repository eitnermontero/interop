...
import bo.com.sintesis.hub.audit.hub.IdempotencyKeyConflictException;
...
/**
 * Interceptor Spring MVC que registra auditoría completa del hub por cada
 * operación inbound: hash del request, hash del response, latencia,
...
public class HubAuditInterceptor implements HandlerInterceptor {
    ...
    /**
     * Atributo de request que pone {@link bo.com.sintesis.hub.base.hub.inbound.DispatcherController}
